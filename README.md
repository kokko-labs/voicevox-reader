...
- 🌐 **OS 標準の音声にも対応**: 英文など、VOICEVOX に向かない文章は OS 内蔵の音声で読めます
...
|---------|------|------------------------|
| 読み上げモデル | VOICEVOX の音声、または OS 標準の音声を選択 | 次の文から切り替わります |
| 再生速度 | 0.5x ～ 2.0x の範囲で調整可能 | 下記のとおり方式で異なります |
| 音量 | 0% ～ 100% の範囲で調整可能 | 下記のとおり方式で異なります |

### 読み上げモデル

一覧は2つの組に分かれています。

**VOICEVOX** — VOICEVOX のエンジンが動いている必要があります。日本語向けです。

**OS 標準の音声** — Windows などに入っている音声です。**VOICEVOX を起動していなくても使えます。**
英語の読み上げに向いており、VOICEVOX では正しく読めない英文はこちらを選んでください。

速度と音量の反映のされ方が方式によって違います。

| | 再生中の速度・音量の変更 |
|---|---|
| VOICEVOX | 音量はその場で反映。速度もその場で変わり、次の文から本来の音声で合成されます |
| OS 標準の音声 | どちらも次の文から反映されます。発話の途中では変えられないためです |
